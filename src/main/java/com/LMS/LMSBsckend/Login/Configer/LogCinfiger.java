...
public class LogCinfiger {
	...
	public SecurityFilterChain securityfilterchain(HttpSecurity http) throws Exception {
		http.csrf(customizte->customizte.disable())
	...
	@Bean //login form is manval get
	public AuthenticationManager authendication(AuthenticationConfiguration config ) throws Exception {
